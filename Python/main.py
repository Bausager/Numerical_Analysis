...
plt.plot(x, lagrange1, marker='.', linestyle="None", label="lagrange_interp1", alpha=0.1)
plt.plot(x, lagrange2, marker='.', linestyle="None", label="lagrange_interp2", alpha=0.1)

from scipy.interpolate import lagrange
from numpy.polynomial.polynomial import Polynomial
poly = lagrange(X, Y)
plt.plot(x, Polynomial(poly.coef[::-1])(x), label='Polynomial', marker='.', linestyle="None", alpha=0.5)


plt.plot(x, cubic_spine, marker='H', linestyle="None", label="cubic_spine", alpha=1)
